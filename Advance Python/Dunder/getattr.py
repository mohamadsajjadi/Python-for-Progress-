# می‌خواهیم کلاسی در زبان پایتون طراحی کنیم که عملکرد یک پروکسی را برای اشیائی که نماینده‌ٔ آنان‌ است داشته باشد. دقت کنید که این کلاس باید قادر باشد تمامی توابعی را که روی شی اصلی فراخوانی می‌شوند، بدون تغییر کارکرد روی آن اجرا کند. توجه کنید که این شئ می‌تواند از هر نوع کلاسی باشد.
